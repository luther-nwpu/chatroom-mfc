...
void AES::f_func(bool in[32], const bool ki[48])
{
	static bool mr[48];
...
void AES::s_func(bool out[32], const bool in[48])
{
...
void AES::transform(bool * out, bool * in, const char * table, int len)
{
	static bool tmp[256];
	for (int i = 0; i<len; i++)
		tmp[i] = in[table[i] - 1];
...
void AES::fxor(bool * ina, const bool * inb, int len)
{
	for (int i = 0; i<len; i++)
		ina[i] ^= inb[i];
}

void AES::rotatel(bool * in, int len, int loop)
{
	static bool tmp[256];
	memcpy(tmp, in, loop);
...
void AES::bytetobit(bool * out, const char * in, int bits)
{
	for (int i = 0; i<bits; i++)
		out[i] = (in[i / 8] >> (i % 8)) & 1;
}

void AES::bittobyte(char * out, const bool * in, int bits)
{
...
void AES::des_run(char out[8], char in[8], bool type)
{
...
void AES::des_setkey(const char key[8])
{
